const CONFIG = {
  ...
  SIMPLE_LOGO_IMG: 'https://mana.tokyo/static/picture/logo.png',
  SIMPLE_TOP_BAR: true, // 显示顶栏SIMPLE_TOP_BAR： true， // 显示顶栏
  SIMPLE_TOP_BAR_CONTENT: process.env.NEXT_PUBLIC_THEME_SIMPLE_TOP_TIPS || '',
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>Mana makes learning easy!</div>',
